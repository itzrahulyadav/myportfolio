...
const Links = () => {
    return (
        <div className="flex align-center justify-center mt-4 rahul">
            ...
            <a className="text-xl m-1 p-1 sm:m-2 sm:p-2  hover:bg-gray-800 rounded-full hover:text-white transition-color duration-300" href="https://github.com/itzrahulyadav">
                <GrInstagram color = "hotpink" />
            </a>
            <a className="text-xl m-1 p-1 sm:m-2 sm:p-2 text-blue-600 hover:bg-gray-800 rounded-full hover:text-white transition-color duration-300" href="https://github.com/itzrahulyadav">
                <GrLinkedin />
            </a>
